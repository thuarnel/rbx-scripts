...
local function get_torso(p)
    ...
    if c then
        ...
        for _, t in pairs(c:GetChildren()) do
            if is_within_tolerance(t.Size.X, target_torso_size.X, torso_tolerance) and is_within_tolerance(t.Size.Y, target_torso_size.Y, torso_tolerance) and is_within_tolerance(t.Size.Z, target_torso_size.Z, torso_tolerance) then
                return t
            end
        end
    end
